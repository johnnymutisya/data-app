...
public class ByaAgeActivity extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bya_age);
    ...
    private void fetchData() {
        AndroidNetworking.get(Urls.FETCH_USER_REPORTS_BY_AGE)
                        ...
                        try {
                            if (response.getBoolean("success")) {
                                ...
                                for (int i=0; i<array.length(); i++){
                                    ...
                                    String title= itemObj.getString("key");
