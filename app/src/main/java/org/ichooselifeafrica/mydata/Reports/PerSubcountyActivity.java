...
public class PerSubcountyActivity extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_per_subcounty);
    ...
    private void fetchData() {
        AndroidNetworking.get(Urls.FETCH_USER_REPORTS_PER_SUB_COUNTY)
                        ...
                        try {
                            if (response.getBoolean("success")) {
                                ...
                                for (int i=0; i<array.length(); i++){
                                    ...
                                    String title= itemObj.getString("sub_county");
