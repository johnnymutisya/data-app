...
public class PerSealActivity extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_per_seal);
    ...
    private void fetchData() {
        AndroidNetworking.get(Urls.FETCH_USER_REPORTS_PER_SEAL)
                        ...
                        try {
                            if (response.getBoolean("success")) {
                                ...
                                for (int i=0; i<array.length(); i++){
                                    ...
                                    int count= itemObj.getInt("YouthCount");
