...
import org.ichooselifeafrica.mydata.YouthInSchoolActivity;
...
public class PerWardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_per_ward);
    ...
    private void fetchData() {
        AndroidNetworking.get(Urls.FETCH_USER_REPORTS_WARD)
                        ...
                        try {
                            if (response.getBoolean("success")) {
                                ...
                                for (int i=0; i<array.length(); i++){
                                    ...
                                    String title= itemObj.getString("ward");
